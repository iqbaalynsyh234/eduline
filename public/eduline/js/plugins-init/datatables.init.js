...
(function ($) {
    ...
    var table2 = $("#example-kbm").DataTable({
        createdRow: function (row, data, index) {
            $(row).addClass("selected");
        },
        searching: false,
        ...
        language: {
            ...
            lengthMenu: "Tampilkan _MENU_ entri", // Translate "Show Entries"
            info: "Menampilkan _START_ sampai _END_ dari _TOTAL_ entri", // Update info text
        },
        data: kbmData, 
        columns: [
            { data: "no" },
